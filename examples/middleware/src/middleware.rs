use feather::{info, middlewares::Middleware, next};
...
impl Middleware for MyMiddleware {
    fn handle(&self, _request: &mut feather::Request, _response: &mut feather::Response, _ctx: &feather::AppContext) -> feather::Outcome {
